...
def matching(image, keypoints, patchSize, allProbablities, allIndexList, fernNum, fernSize):
    ...
    matchingResults = np.zeros((len(keypoints),1)).astype(np.int32)
